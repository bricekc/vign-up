 ...
 */
final class Version20221223110526 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resultat_questionnaire CHANGE commentaire commentaire VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE resultat_questionnaire CHANGE commentaire commentaire LONGTEXT DEFAULT NULL');
    }
}
